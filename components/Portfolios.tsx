export default function Portfolios() {
    return <section className="pt-8 pb-14 border-t border-black border-opacity-10 border-dashed">
        <div className="container grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 content-center">
            <PortfolioItem title="Peregrinus" img="portfolios/peregrinus2.webp" icon="portfolios/peregrinus-icon.webp" link="https://peregrinus.com.uy" />
            <PortfolioItem title="Midinero" img="portfolios/midinero2.webp" icon="portfolios/midinero-icon.webp" link="https://midinero.com.uy" imgWrapperClasses="bg-[#C2E2FF]" />
            <PortfolioItem title="Innuy" img="portfolios/innuy2.webp" icon="portfolios/innuy-icon.webp" link="https://innuy.com" imgWrapperClasses="bg-[#FBD4B6]" />
            <PortfolioItem title="Seva.Love" img="portfolios/seva-love.webp" icon="portfolios/seva-love-icon.webp" link="https://seva.love" imgWrapperClasses="bg-[#D2C3EF]" />
            <PortfolioItem title="Edward & Associates" img="portfolios/edwards-associates.webp" icon="portfolios/edwards-associates-icon.svg" link="https://eandassociates.com/" imgWrapperClasses="bg-[#D0F1C0]" />
            <PortfolioItem title="Market Street Family Dental" img="portfolios/market-street-dental.webp" icon="portfolios/market-street-dental-icon.webp" link="https://troyildentist.com/" imgWrapperClasses="bg-[#C0F1DA]" />
        </div>
    </section>
}
...
function PortfolioItemVariant3({ title, img, icon, link, imgWrapperClasses = 'bg-[#CFE5E7]' }: ItemProps) {
    return <a href={link} target="_blank" className="group max-w-lg mx-auto">
