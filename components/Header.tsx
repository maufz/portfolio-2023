export default function Header() {
  return <header>
    <div className="relative h-24 lg:h-44 bg-gradient-to-b from-teal-400 to-cyan-600 after:absolute after:inset-0 after:backdrop-blur after:border-b -after:border-black after:border-opacity-10"></div>
    <div className="relative border-b border-black border-opacity-10 border-dashed">
      <div className="max-w-2xl mx-auto px-3 flex items-center">
        ...
        <div className="flex items-center gap-[2px]">
          <a href="https://github.com/maufz" className="p-2" target="_blank"><img src="mdi_github.svg" alt="" /></a>
