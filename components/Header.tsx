  ...
  return <header>
    ...
    <div className="relative border-b border-black border-opacity-10 border-dashed">
      <div className="max-w-2xl mx-auto px-3 flex items-center">
        <img src="profile.webp" className="w-[120px] h-[120px] rounded-full mt-[-60px] inline-block border-2 border-white mr-2" alt="Foto de Mauro Fernández" />
        <div className="flex items-center gap-[2px]">
          <a href="https://github.com/maufz" className="p-2 hover:opacity-80 transition-opacity" target="_blank"><img src="mdi_github.svg" alt="Github" aria-label="Visita mi perfil de Github" /></a>
          <a href="https://www.linkedin.com/in/mauro-fern%C3%A1ndez-6a3052198/" className="p-2 hover:opacity-80 transition-opacity" target="_blank" aria-label="Visita mi perfil de Linkedin"><img src="akar-icons_linkedin.svg" alt="Linkedin" /></a>
        </div>
      </div>
    </div>
  </header  >
