...
export default function Header() {
  ...
  return <header>
    <div className={`relative ${coverState} bg-gradient-to-b from-teal-400 to-cyan-600 after:absolute after:inset-0 after:backdrop-blur after:border-b -after:border-black after:border-opacity-10 transition-all cursor-pointer`} onClick={handleCoverClick}></div>
